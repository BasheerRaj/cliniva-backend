...
describe('EntityRelationshipUtil', () => {
  describe('validateEntityHierarchy', () => {
    describe('Company Plan Hierarchy', () => {
      it('should validate company plan with organization only', () => {
        ...
        const result = EntityRelationshipUtil.validateEntityHierarchy('company', entities);
    ...
    describe('Complex Plan Hierarchy', () => {
      it('should validate complex plan with complexes and departments', () => {
        ...
        const result = EntityRelationshipUtil.validateEntityHierarchy('complex', entities);
        expect(result).toBe(true);
      });
    ...
    describe('Clinic Plan Hierarchy', () => {
      it('should validate clinic plan with clinics', () => {
        ...
        const result = EntityRelationshipUtil.validateEntityHierarchy('clinic', entities);
        expect(result).toBe(true);
      });
    ...
    describe('Invalid Plan Types', () => {
      it('should reject invalid plan type', () => {
        ...
        const result = EntityRelationshipUtil.validateEntityHierarchy('invalid', entities);
        expect(result).toBe(false);
      });
      ...
      it('should be case insensitive', () => {
        ...
        const result1 = EntityRelationshipUtil.validateEntityHierarchy('COMPANY', entities);
        const result2 = EntityRelationshipUtil.validateEntityHierarchy('Company', entities);
        const result3 = EntityRelationshipUtil.validateEntityHierarchy('company', entities);
  ...
  describe('getRequiredEntitiesForPlan', () => {
    it('should return required entities for company plan', () => {
      const required = EntityRelationshipUtil.getRequiredEntitiesForPlan('company');
      expect(required).toEqual(['organization']);
    });

    it('should return required entities for complex plan', () => {
      const required = EntityRelationshipUtil.getRequiredEntitiesForPlan('complex');
      expect(required).toEqual(['complex', 'department']);
    });

    it('should return required entities for clinic plan', () => {
      const required = EntityRelationshipUtil.getRequiredEntitiesForPlan('clinic');
      expect(required).toEqual(['clinic']);
    });

    it('should return empty array for invalid plan', () => {
      const required = EntityRelationshipUtil.getRequiredEntitiesForPlan('invalid');
      expect(required).toEqual([]);
    });

    it('should be case insensitive', () => {
      const required1 = EntityRelationshipUtil.getRequiredEntitiesForPlan('COMPANY');
      const required2 = EntityRelationshipUtil.getRequiredEntitiesForPlan('Company');
      const required3 = EntityRelationshipUtil.getRequiredEntitiesForPlan('company');
  ...
  describe('validateEntityDependencies', () => {
    it('should validate organization dependencies (no dependencies)', () => {
      const result = EntityRelationshipUtil.validateEntityDependencies('organization', []);
      expect(result).toBe(true);
    });

    it('should validate complex dependencies', () => {
      const dependencies = [{ type: 'subscription', id: 'sub_123' }];
      const result = EntityRelationshipUtil.validateEntityDependencies('complex', dependencies);
      expect(result).toBe(true);
    });

    it('should validate clinic dependencies', () => {
      const dependencies = [{ type: 'subscription', id: 'sub_123' }];
      const result = EntityRelationshipUtil.validateEntityDependencies('clinic', dependencies);
      expect(result).toBe(true);
    });
    ...
    it('should validate complexDepartment dependencies', () => {
      ...
      const result = EntityRelationshipUtil.validateEntityDependencies('complexDepartment', dependencies);
      expect(result).toBe(true);
    });

    it('should validate service dependencies', () => {
      const dependencies = [{ type: 'complexDepartment', id: 'cd_123' }];
      const result = EntityRelationshipUtil.validateEntityDependencies('service', dependencies);
      expect(result).toBe(true);
    });

    it('should validate workingHours dependencies', () => {
      const dependencies = ['entity_123']; // Simple string ID for entity
      const result = EntityRelationshipUtil.validateEntityDependencies('workingHours', dependencies);
      expect(result).toBe(true);
    });

    it('should validate contact dependencies', () => {
      const dependencies = ['entity_123'];
      const result = EntityRelationshipUtil.validateEntityDependencies('contact', dependencies);
      expect(result).toBe(true);
    });
    ...
    it('should validate userAccess dependencies', () => {
      ...
      const result = EntityRelationshipUtil.validateEntityDependencies('userAccess', dependencies);
      expect(result).toBe(true);
    });
    ...
    it('should handle unknown entity type', () => {
      const dependencies = [];
      const result = EntityRelationshipUtil.validateEntityDependencies('unknown', dependencies);
  ...
  describe('generateEntityStructure', () => {
    it('should generate structure for company plan', () => {
      ...
      const structure = EntityRelationshipUtil.generateEntityStructure('company', inputData);
      ...
      expect(structure.entities.workingHours).toEqual([{ dayOfWeek: 'monday' }]);
    ...
    it('should generate structure for complex plan', () => {
      ...
      const structure = EntityRelationshipUtil.generateEntityStructure('complex', inputData);
    ...
    it('should generate structure for clinic plan', () => {
      ...
      const structure = EntityRelationshipUtil.generateEntityStructure('clinic', inputData);
    ...
    it('should handle single complex in complex plan', () => {
      ...
      expect(structure.entities.complexes).toEqual([{ name: 'Single Complex' }]);
    });
  ...
  describe('validateEntityRelationships', () => {
    it('should validate entities with correct references', () => {
      ...
      const result = EntityRelationshipUtil.validateEntityRelationships(entities);
      expect(result).toBe(true);
    });
  ...
  describe('extractEntityReferences', () => {
    it('should extract all reference fields', () => {
      ...
      const references = EntityRelationshipUtil.extractEntityReferences(entityData);
    ...
    it('should handle null/undefined entity data', () => {
      ...
      const references2 = EntityRelationshipUtil.extractEntityReferences(undefined);
