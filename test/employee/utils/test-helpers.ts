...
/**
 * Helper functions for employee E2E tests
 */
...
export async function createTestEmployee(
  employeeProfileModel: any,
  employeeData: any,
): Promise<any> {
  const employee = new employeeProfileModel(employeeData);
...
export async function cleanupTestData(models: {
  ...
  if (models.employeeProfileModel) {
    promises.push(models.employeeProfileModel.deleteMany({}));
  }
