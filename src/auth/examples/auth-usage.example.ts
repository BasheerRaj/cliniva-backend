...
export class ExampleController {
  ...
  @Get('admin-users')
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Permissions([PermissionsEnum.ADMIN_ACCESS, PermissionsEnum.USER_LIST], { requireAll: true })
  getAdminUsers() {
    return { message: 'This requires both admin access AND user list permissions' };
  }
  ...
  @Get('user-or-admin')
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Permissions([PermissionsEnum.USER_READ, PermissionsEnum.ADMIN_ACCESS], { requireAll: false })
  getUserOrAdminData() {
    return { message: 'This requires either user read OR admin access permission' };
  }
  ...
  @UseGuards(JwtAuthGuard, PermissionsGuard)
  @Permissions([PermissionsEnum.USER_READ], { allowSelf: true, selfParam: 'userId' })
  getUserProfile() {
    return { message: 'User can access their own profile or admin can access any profile' };
  }
}
