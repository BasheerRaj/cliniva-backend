...
export const COMPANY_PLAN_ONBOARDING_EXAMPLE: CompleteOnboardingDto = {
  ...
  organization: {
    ...
    businessProfile: {
      ...
      mission:
        'To provide world-class healthcare services with compassion and excellence, making quality medical care accessible to all communities across Saudi Arabia.',
      vision:
        'To be the leading healthcare provider in the Middle East, known for innovation, patient care excellence, and medical expertise.',
    ...
    legalInfo: {
      ...
      termsConditions:
        'Our comprehensive terms and conditions governing the use of HealthCorp medical services...',
      privacyPolicy:
        'HealthCorp is committed to protecting your privacy and personal health information...',
    },
  },
...
export const COMPLEX_PLAN_ONBOARDING_EXAMPLE: CompleteOnboardingDto = {
  ...
  complexes: [
    {
      ...
      address:
        'Al-Madinah Al-Munawarah Road, Al Aziziyah District, Jeddah 23334',
      ...
      businessProfile: {
        ...
        mission:
          "Providing exceptional women's and children's healthcare with a focus on family-centered care and medical excellence.",
        vision:
          "To be the premier women's and children's medical complex in the Western Region of Saudi Arabia.",
  ...
  departments: [
    ...
    },
    {
      name: 'Pediatrics',
      description:
        'Comprehensive healthcare for newborns, infants, and children',
    },
    {
  ...
  clinics: [
    {
      ...
      address:
        'Prince Sultan Street, Al Khobar Al Shamalia, Al Khobar 34428, Saudi Arabia',
      ...
      businessProfile: {
        ...
        mission:
          'To provide exceptional dental care with a focus on patient comfort, advanced technology, and beautiful, healthy smiles for the entire family.',
        vision:
          'To be the leading dental clinic in the Eastern Province, known for excellence in dental care and patient satisfaction.',
...
export function getOnboardingExampleByPlan(
  planType: string,
